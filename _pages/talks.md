...
<!-- Talks with images: title/info first, then images -->
<style>
.talk-block { max-width: 1000px; margin: 0 auto 40px; }
.talk-block h3 { margin: 0 0 6px; }
.talk-meta { margin: 0 0 10px; line-height: 1.5; }
.talk-authors { font-style: italic; }

.talk-images { margin-top: 14px; }
.talk-images img {
  width: 100%;
  height: auto;
  border-radius: 10px;
...
/* two-column layout for talks with two images */
.talk-images.two {
  display: grid;
  gap: 12px;
...
/* single-image layout (centered, narrower) */
.talk-images.one {
  display: flex;
  justify-content: center;
}
.talk-images.one img {
  width: 75%;            /* tweak to 60–90% if you want */
  max-width: 720px;
}

/* mobile: stack the two images */
@media (max-width: 700px) {
  .talk-images.two { grid-template-columns: 1fr; }
  .talk-images.one img { width: 100%; }
}
</style>

<!-- 2025 — Talk 1 (two images: talk1, talk11) -->
...
<!-- 2024 — Talk 2 (one image: talk2 only) -->
<section class="talk-block">
...
<!-- 2024 — Talk 3 (two images: talk3, talk33) -->
<section class="talk-block">
...
<!-- 2024 — Talk 4 (two images: talk4, talk44) -->
<section class="talk-block">
...
<!-- 2024 — Talk 5 (two images: talk5, talk55) -->
<section class="talk-block">
...
<!-- 2024 — Talk 6 (two images: talk6, talk66) -->
<section class="talk-block">
