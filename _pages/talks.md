...
<style>
/* Layout of each talk block */
.talk-block{
  max-width: 980px;
  margin: 0 auto 56px;
}
.talk-block h3{ margin: 0 0 8px; font-weight: 700; }
.talk-meta{ margin: 2px 0; color:#444; line-height: 1.5; }

/* Image grids */
.talk-images{ margin-top: 16px; }
.img-grid.two{
  display: grid;
...
.frame img{
  ...
  width:100%;
  height:100%;
  object-fit: contain;            /* shows full photo, no crop */
}

/* Single-image: narrower, centered */
.img-grid.one .frame{
  width: 80%;
  max-width: 720px;
}
...
@media (max-width: 700px){
  .img-grid.two{ grid-template-columns: 1fr; }
  .img-grid.one .frame{ width:100%; }
}
</style>
...
<section class="talk-block">
  ...
  <div class="talk-images">
    <div class="img-grid two">
      ...
      <div class="frame"><img src="/images/talks/talk55.jpg" alt="Reverse EXPO talk - photo 2" loading="lazy"></div>
    </div>
  </div>
</section>
...
<section class="talk-block">
  ...
  <div class="talk-images">
    <div class="img-grid two">
      <div class="frame"><img src="/images/talks/talk4.jpg" alt="Alberta BME talk - photo 1" loading="lazy"></div>
      <div class="frame"><img src="/images/talks/talk44.jpg" alt="Alberta BME talk - photo 2" loading="lazy"></div>
    </div>
  </div>
</section>
...
<section class="talk-block">
  ...
  <div class="talk-images">
    <div class="img-grid two">
      ...
      <div class="frame"><img src="/images/talks/talk33.jpg" alt="RISE talk - photo 2" loading="lazy"></div>
    </div>
  </div>
</section>
...
<section class="talk-block">
  ...
  <div class="talk-images">
    <div class="img-grid two">
      ...
      <div class="frame"><img src="/images/talks/talk11.jpg" alt="BERD talk - photo 2" loading="lazy"></div>
    </div>
  </div>
</section>
