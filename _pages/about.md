...
. The objective of my current research is to apply principles of optimal control, state estimation, neuroscience, and reinforcement learning to optimize learning during robotic rehabilitation.
  ...
  <tr>
    ...
    <td style="vertical-align:top; width:50%; text-align:center;">
      <div style="
        ...
        display:flex; align-items:center; justify-content:center;
        background-color:#ffffff; border:1px solid #ddd; border-radius:10px; overflow:hidden;">
        <img src="/images/igmr2.png" alt="IGMR logo" style="width:100%; height:100%; object-fit:contain;">
      </div>
...
<ul>
  ...
  <li><strong>Tools & Technologies:</strong> ROS, Git, LaTeX, VS Code, Unity, Linux (Ubuntu), Arduino</li>
